...
public class Constant
{
    ...
    public static String TODO_JSON_REQUEST = DIR+"/src/test/resources/JSON/Request/Todos";
    public static String POSTS_JSON_REQUEST = DIR+"/src/test/resources/JSON/Request/Posts";
    public static String COMMENTS_JSON_REQUEST = DIR+"/src/test/resources/JSON/Request/Comments";
    public static String ALBUMS_JSON_REQUEST = DIR+"/src/test/resources/JSON/Request/Albums";
